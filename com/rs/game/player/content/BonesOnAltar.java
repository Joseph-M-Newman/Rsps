...
public class BonesOnAltar extends Action {
	...
	public enum Bones {
		BONES(new Item(526, 1), 20),
		BIG_BONES(new Item(532, 1), 30),
		BABYDRAGON_BONES(new Item(534, 1), 60),
		WYVERN_BONES(new Item(6812, 1), 100),
		DRAGON_BONES(new Item(536, 1), 250),
		OURG_BONES(new Item(4834, 1), 300),
		FROST_DRAGON_BONES(new Item(18830, 1), 350),
		DAGANNOTH_BONES(new Item(6729, 1), 260);
