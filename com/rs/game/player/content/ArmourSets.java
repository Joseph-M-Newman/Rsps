...
public class ArmourSets {
	...
	public enum Sets { // Hours of finding id's :S - Sonic
		...
		BRONZE_LG(11814, 1155, 1117, 1075, 1189), BRONZE_SK(11816, 1155, 1117,
				...
				14492, 14490), THIRDAGEMELEE(11858, 10350, 10348, 10352, 10346), AHRIM(
				11846, 4708, 4710, 4712, 4714), DHAROK(11848, 4716, 4718, 4720, 4722), GUTHAN(
				11850, 4724, 4726, 4728, 4730), KARIL(11852, 4732, 4734, 4736, 4738), TORAG(
				11854, 4745, 4747, 4749, 4751), VERAC(11856, 4753, 4755, 4757, 4759), AKRISAE(
				21768, 21736, 21744, 21752, 21760), THIRDAGERANGE(
				11860, 10334, 10330, 10332, 10336), THIRDAGEMAGE(
				11862, 10342, 10334, 10338, 10340);
