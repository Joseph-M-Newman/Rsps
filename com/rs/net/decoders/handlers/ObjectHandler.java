...
import com.rs.game.player.actions.Farming.Allotments;
import com.rs.game.player.actions.Farming.Flowers;
import com.rs.game.player.actions.Farming.Herbs;
import com.rs.game.player.actions.Farming.Trees;
...
import com.rs.game.player.content.CompostBin;
...
import com.rs.game.player.content.MaxedUserD;
...
import com.rs.game.player.dialogues.ConTableD;
...
public final class ObjectHandler {
			...
			public void run() {
				...
				if (!player.getControlerManager().processObjectClick1(object))
				    ...
				    if (player.getInventory().getFreeSlots() < 1) {
				        player.getDialogueManager().startDialogue("SimpleMessage", "Unfortunately, you do not have enough space in your inventory.");
				        return;
				    }
				    if (player.getSkills().getLevel(Skills.CONSTRUCTION) >= 1) {
				        ...
				        player.getDialogueManager().startDialogue("SimpleMessage", "You Take a Saw");
				    }
				} else if (id == 46300)
					if(!player.getInventory().containsItem(8794, 1) || !player.getInventory().containsItem(960, 1)) {
						player.getPackets().sendGameMessage("To start, you'll need a saw and some Planks, look carefully around!");
						} else {
						player.getPackets().sendGameMessage("You are working...");
						player.setNextAnimation(new Animation(5));
						player.getInventory().deleteItem(new Item(3438, 1));
						player.getInventory().addItem(960, 1);
						player.getSkills().addXp(22, 340);
						player.getInventory().refresh();
						player.lock(5);
				} else if (id == 46297) {
				    if (player.getInventory().getFreeSlots() < 1) {
				        player.getDialogueManager().startDialogue("SimpleMessage", "Unfortunately, you do not have enough space in your inventory to pick anymore Logs up.");
				        return;
				    }
				    if (player.getSkills().getLevel(Skills.CONSTRUCTION) >= 1) {
				        player.setNextAnimation(new Animation(45));
				        player.lock(4);
				        player.getInventory().addItem(1511, 5);
				        player.getDialogueManager().startDialogue("SimpleMessage", "You've taken some Logs.");
				        return;
				    }
				} else if (id == 61836) {
				    if (player.getInventory().getFreeSlots() < 1) {
				    ...
				    if (player.getSkills().getLevel(Skills.CONSTRUCTION) >= 1) {
				        player.setNextAnimation(new Animation(45));
				        player.lock(4);
				        player.getInventory().addItem(3438, 5);
				        player.getDialogueManager().startDialogue("SimpleMessage", "You've taken some Pyre Logs.");
				        return;
				    }
				} else if (id == 46304) {
				    if (player.getInventory().containsItem(1511, 1)) {
				        ...
				        player.getSkills().addXp(22, 245);
				        player.getDialogueManager().startDialogue("SimpleMessage", "You Throw Some Logs Into the Conveyor Belt Hopper");
				        return;
				    }
				    if (player.getSkills().getLevel(Skills.CONSTRUCTION) >= 1) {
				        player.getDialogueManager().startDialogue("SimpleMessage", "You need 5 Logs To Function The Conveyor Belt");
				    }
				} else if (id == 46313) {
				    if (player.getInventory().addItem(960, 1)) {
				        player.setNextAnimation(new Animation(5));
				        player.lock(3);
				        player.getDialogueManager().startDialogue("SimpleMessage", "You've taken some Panks.");
				        return;
				    }
				    if (player.getSkills().getLevel(Skills.CONSTRUCTION) >= 1) {
				        player.getDialogueManager().startDialogue("SimpleMessage", "There is No Planks Here to Collect");
				        return;
				    }
				}
				...
				if (id == 47237) {
				    ...
				    if (player.getInventory().addItem(960, 1)) {
				        ...
				        player.getSkills().addXp(22, 3);
				        player.lock(3);
				        player.getDialogueManager().startDialogue("SimpleMessage", "You've taken some Planks.");
				        return;
				    }
				    if (player.getSkills().getLevel(Skills.CONSTRUCTION) >= 1) {
				        player.getDialogueManager().startDialogue("SimpleMessage", "There is No Planks Here to Collect");
				...
				if (id == 2563) {
					player.getDialogueManager().startDialogue("CompletionistStand");
				 }
				if (id == 2562) {
				...
				if (id == 540) {
					player.getDialogueManager().startDialogue("ConTableD");
				}
				...
				if (id == 2079) {
					player.getDialogueManager().startDialogue("CrystalChest");
				}
				else if (id == 12309)
					if(!player.isCompletedRecipeforDisaster()) {
					player.getPackets().sendGameMessage("You must complete Recipe for Disaster to access this.");
	}else{
	...
	if (id == 29958 || id == 4019 || id == 50205 || id == 50206 || id == 50207 || id == 53883 || id == 54650 || id == 55605 || id == 56083 || id == 56084 || id == 56085 || id == 56086) {
	    ...
	    return;
				...
				if (hunterNpc != null) {
					...
					player.getDialogueManager().startDialogue("SpiritTreesD");
				else if (id == 2563) 
					player.getDialogueManager().startDialogue("CompletionistStand");
				else if (id == 68974)
	...
	//}else{
		//			ShopsHandler.openShop(player, 24);
			...
			private void setArmadylKC(int i) {
				// TODO Auto-generated method stub
				
			}

			private int getArmadylKC() {
				// TODO Auto-generated method stub
				return 0;
			}

			private void setZammyKC(int i) {
				// TODO Auto-generated method stub
				
			}

			private int getZammyKC() {
				// TODO Auto-generated method stub
				return 0;
			}

			private void setBandosKC(int i) {
				// TODO Auto-generated method stub
				
			}

			private int getBandosKC() {
				// TODO Auto-generated method stub
				return 0;
			}
		...
		player.setCoordsEvent(new CoordsEvent(object, new Runnable() {
			...
			public void run() {
				...
				if (!player.getControlerManager().processObjectClick2(object))
				    ...
				    if (player.getInventory().getFreeSlots() < 1) {
				        player.getDialogueManager().startDialogue("SimpleMessage", "Unfortunately, you do not have enough space in your inventory to pick up another log.");
				        return;
				    }
				    if (player.getSkills().getLevel(Skills.CONSTRUCTION) >= 1) {
				        player.setNextAnimation(new Animation(45));
				        player.getInventory().addItem(1511, 1);
				        player.getDialogueManager().startDialogue("SimpleMessage", "You've taken a Log from the pile.");
				        return;
				    }
				} else if (id == 61836) {
				    if (player.getInventory().getFreeSlots() < 1) {
				    ...
				    if (player.getInventory().containsItem(1511, 1)) {
				        ...
				        player.getInventory().deleteItem(1511, 1);
				        player.getSkills().addXp(22, 245);
				        player.getDialogueManager().startDialogue("SimpleMessage", "You Throw a Logs Into the Conveyor Belt Hopper.");
				        return;
				    }
				    if (player.getSkills().getLevel(Skills.CONSTRUCTION) >= 1) {
				        player.getDialogueManager().startDialogue("SimpleMessage", "You need 5 Logs To Function The Conveyor Belt.");
				    ...
				    if (player.getInventory().addItem(960, 1)) {
				        player.setNextAnimation(new Animation(5));
				        player.lock(3);
				        player.getDialogueManager().startDialogue("SimpleMessage", "You take a Wood Plank");
				        return;
				    }
				    if (player.getSkills().getLevel(Skills.CONSTRUCTION) >= 1) {
				        player.getDialogueManager().startDialogue("SimpleMessage", "There is No Planks Here to Collect");
				    ...
				    player.getDialogueManager().startDialogue("SimpleMessage", "You Choose a Quick Construction Task");
				}
				    ...
				    if (player.getInventory().addItem(960, 1)) {
				        player.setNextAnimation(new Animation(10));
				        player.lock(3);
				        player.getSkills().addXp(22, 3);
				        player.getDialogueManager().startDialogue("SimpleMessage", "You take a Wood Plank");
				        return;
				...
				String THIEVING_MESSAGE1 = "You successfully thieve from the stall";
				boolean THIEVING_SUCCESS = false;// Eigenlijk moet dit false
									...
									if (player.getSkills().getLevel(Skills.THIEVING) >= 1) {
										...
										player.getInventory().addItem(4580, 1);
										player.getSkills().addXp(17, 4);
									} else {
										player.getPackets()
										.sendGameMessage(
									...
									if (player.getSkills().getLevel(Skills.THIEVING) >= 1) {
										THIEVING_SUCCESS = true;
										player.getInventory().addItem(1241, 1);
										player.getSkills().addXp(17, 2);
									} else {
										player.getPackets()
										.sendGameMessage(
								...
								if (THIEVING_SUCCESS) {
									player.applyHit(new Hit(player, Utils.getRandom(15)+5,
									HitLook.REGULAR_DAMAGE));
									player.setNextAnimation(new Animation(881));
									player.getPackets().sendGameMessage(THIEVING_MESSAGE1);
									player.lock(1);
								}
					if (id == 29394) {			
		...
		player.setCoordsEvent(new CoordsEvent(object, new Runnable() {
			...
			public void run() {
				...
				if (!player.getControlerManager().processObjectClick3(object))
				    ...
				    player.getInventory().deleteItem(1511, 1);
				    player.setNextAnimation(new Animation(45));
				    player.getDialogueManager().startDialogue("SimpleMessage", "You Place some Logs back");
				} else if (id == 46296) {
				    player.getDialogueManager().startDialogue("SimpleMessage", "You Choose a Large Construction Task");
				}
				if (id == 29395) {
