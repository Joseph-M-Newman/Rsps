...
public class ButtonHandler {
	...
	public static void handleButtons(final Player player, InputStream stream,
       ...
       //p.addSkillXP(10000+500*p.skillLvl[18], 18);
		...
		player.getSkills().addXp(18, 1000);
		player.getPackets().sendIComponentText(163, 20, "" + player.getSlayerPoints() + "");
		player.getPackets().sendGameMessage("You buy some slayer experience.");
        } else {
		player.getPackets().sendGameMessage("You need 500 slayerPoints to buy slayer xp.");
        }
		...
		case 2://player rankings
			...
			player.getPackets().sendIComponentText(1245, 14, "<img=1>Nilez - Programmer and The Owner<img=1>");
			player.getPackets().sendIComponentText(1245, 15, "<img=1>Enth - Programmer and The Owner<img=1>");
			player.getPackets().sendIComponentText(1245, 16, "");
			player.getPackets().sendIComponentText(1245, 17, "");
			player.getPackets().sendIComponentText(1245, 18, "<img=0>Global Moderator<img=0>");
			player.getPackets().sendIComponentText(1245, 19, "");
			player.getPackets().sendIComponentText(1245, 20, "<img=15>Supporter<img=15>");
		...
		case 14://skilling
			...
			case 90: // Slayer
				...
				player.setNextForceTalk(new ForceTalk(
						"<col=ff0000>My slayer task is to kill "
